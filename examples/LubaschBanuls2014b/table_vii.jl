...
gen_result_path(D1::Int, D2::Int, B::Real) = "result/Table_vii_D1$(D1)_D2$(D2)_B$(B).json"
...
function main(parameters = [(5000, -0.001, 1.0e-9), (500, -0.0001, 1.0e-9)];D2::Int, B::Real, D1::Int=2*D2^2+10)
	m = 21
	n = 21
	L = m * n
