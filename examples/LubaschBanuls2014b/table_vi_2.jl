...
gen_result_path(m::Int, n::Int, D1::Int, D2::Int, B::Real) = "result/Table_vi_m$(m)_n$(n)_D1$(D1)_D2$(D2)_B$(B).json"


function main(m::Int, n::Int=m;D2::Int, B::Real, D1::Int=2*D2^2)
	# m = 11
	# n = 11
	L = m * n
	...
	if D2 == 2
		...
		peps_path = gen_peps_path(m, n, D2-1, B) 
	...
	file_name = gen_result_path(m, n, D1, D2, B) 
