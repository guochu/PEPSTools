...
using QuantumSpins, PEPSTools, Random
...
function main(m::Int; block_size::Int, D2::Int, D1::Int=2*D2^2+10) 
	...
	times = Float64[]
	energies = [expectation(h, peps, measure_alg) / prod(size(peps))]
	...
	result_path = "result/serial_bp_m$(m)_blocksize_$(block_size)_D2_$(D2)_D1_$(D1).json"
