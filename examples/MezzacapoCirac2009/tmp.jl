...
function main(m::Int, n::Int, parameters = [(2000, -0.001, 1.0e-8), (1000, -0.0001, 1.0e-9), (200, -0.00001, 1.0e-9)]; B::Real, block_size::Tuple{Int, Int}, D2::Int, D1::Int=2*D2^2+10)
	...
	bp_alg = BlockBP(block_size=block_size, msg_D=D2^2, update_alg=exp_alg, verbosity=3)
	measure_alg = bp_alg
	...
	gs_alg = ImaginaryTimePEPS(parameters, stepper=bp_alg, measure_alg=measure_alg, sweeps_per_measure=100, verbosity=2)
