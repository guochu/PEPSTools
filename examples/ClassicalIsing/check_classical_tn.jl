...
function main_non_periodic(m::Int, h::Real=1.0e-3; block_size::Int = div(m,2))
	...
	# data_path = "result/classical_non_periodic_tn_N$(m)_h$(h)_blocksize$(block_size)_D$(D1).json"
...
# 	betas_list = vcat(collect(0.2:0.05:0.4), collect(0.405:0.005:0.495), collect(0.5:0.05:1.5))
...
# 	for beta in betas_list
# 		obs1 = magnetization(model, i, j, BoundaryMPO(D2=D2, D1=D1), β=beta)
# 		obs2 = magnetization(model, i, j, exp_alg, β=beta)
# 		m_Onsager = Onsager_m(beta)
...
# 	data_path = "result/classical_periodic_tn_N$(m)_h$(h)_blocksize$(block_size)_D$(D1).json"
