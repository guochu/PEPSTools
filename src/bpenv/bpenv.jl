...
function BP(normalize_alg::MessageNormalizationAlgorithm; msg_maxiter::Int=10, msg_tol::Real=1.0e-8, initguess::Symbol=:unit, damping::Real=0, seed::Int=1354, verbosity::Int=0)
